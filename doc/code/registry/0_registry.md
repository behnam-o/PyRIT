...
accept member names or values, and word-selection parameters accept built-in
strategy configurations; both also accept existing Python objects. Use `Path` for a
